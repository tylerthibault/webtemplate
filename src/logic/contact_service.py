...
class ContactService:
    ...
    def validate_contact_data(cls, name, email, subject, message):
        ...
        is_valid_name, name_error = ValidationUtils.validate_name(
            name, min_length=cls.MIN_NAME_LENGTH, max_length=cls.MAX_NAME_LENGTH
        )
    ...
    def submit_contact_form(cls, name, email, subject, message):
        ...
        try:
            ...
            confirmation_sent, confirmation_error = (
                EmailUtils.send_contact_confirmation(
            ...
            notification_sent, notification_error = (
                EmailUtils.send_contact_notification(
                    contact_data, current_app._get_current_object()
                )
            )
            ...
            if confirmation_sent:
                ...
                current_app.logger.warning(
                    f"Confirmation email failed: {confirmation_error}"
                )
    ...
    def mark_confirmation_sent(contact_id):
        ...
        try:
            ...
            return {"success": True, "message": "Confirmation email marked as sent"}
        except Exception as e:
    ...
    def mark_admin_notified(contact_id):
        ...
        try:
            ...
            return {"success": True, "message": "Admin notification marked as sent"}
        except Exception as e:
            return {"success": False, "message": f"Update failed: {str(e)}"}
