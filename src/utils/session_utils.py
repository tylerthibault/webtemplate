...
class SessionUtils:
    ...
    def get_session_info(session_hash):
        ...
        return {
            ...
            'created_at': coat_hanger.created_at.isoformat() if coat_hanger.created_at else None,
            'updated_at': coat_hanger.updated_at.isoformat() if coat_hanger.updated_at else None,
    ...
    def get_active_sessions_count():
        ...
        """
        cutoff_time = datetime.utcnow() - timedelta(seconds=CoatHanger.SESSION_TIMEOUT_SECONDS)
        active_sessions = CoatHanger.query.filter(CoatHanger.updated_at >= cutoff_time).count()
