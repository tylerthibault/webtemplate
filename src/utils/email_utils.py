...
class EmailUtils:
    ...
    @staticmethod
    def create_contact_confirmation_email(name: str, email: str, subject: str, message: str) -> Dict[str, str]:
        """
    ...
    @staticmethod
    def create_contact_notification_email(name: str, email: str, subject: str, message: str, submitted_at: datetime) -> Dict[str, str]:
        """
    ...
    @staticmethod
    def send_contact_confirmation(contact_data: Dict, app) -> tuple[bool, Optional[str]]:
        """
    ...
    @staticmethod
    def send_contact_notification(contact_data: Dict, app) -> tuple[bool, Optional[str]]:
        """
