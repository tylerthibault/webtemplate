...
<!--
  ...
  real paths (e.g., src/controllers/user_routes.py, src/logic/user_service.py). 
  The delivered plan must not include Option labels.
-->
```
# [REMOVE IF UNUSED] Option 1: Flask MVC (DEFAULT for this project)
src/
...
# [REMOVE IF UNUSED] Option 2: Single project (non-Flask)
src/
├── models/
├── services/
├── cli/
